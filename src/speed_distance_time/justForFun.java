...
public class justForFun {
	public static void main(String args[]) {
		...
		// TIME----------------------------------------------------//
		case 1:
			// makes a new scanner for(users input) called 'ekey' to hold Users
			// VELOCITY input.
			Scanner ekey = new Scanner(System.in);
			System.out.print("\n\nPlease enter a velcoity in m/s:\n");
			velocity = ekey.nextDouble();
			// end of 'ekey' for scanner, change scanner variable to 'ekeyp' to
			// hold Users DISTANCE Input.
		...
		// DISTANCE------------------------------------------------//
		case 2: // distance:
				// makes a new scanner for(users input) called 'key' to hold
				// Users VELOCITY input
			Scanner key = new Scanner(System.in);
			System.out.print("\n\nPlease enter the velocity in m/s:\n");
			velocity = key.nextDouble();

			// end of 'key' for scanner, change scanner variable to 'keyp' to
			// hold Users TIME Input.
		...
		// VELOCITY-------------------------------------------------//
		case 3: // Velocity:
				// makes a new scanner for(users input) called 'ke' to hold
				// Users TIME input
			Scanner ke = new Scanner(System.in);
			System.out.print("\n\nPlease enter the time in Seconds:\n");
			Time = ke.nextDouble();

			// end of 'ke' for scanner, change scanner variable to 'k' to hold
			// Users DISTANCE Input.
